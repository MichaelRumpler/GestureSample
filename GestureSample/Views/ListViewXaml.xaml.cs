...
namespace GestureSample.Views
{
	public partial class ListViewXaml
	{
		...
		private void Button_Tapped(object sender, MR.Gestures.TapEventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText($"ListView.Header Button_Tapped.");
		}

		private void Button_Clicked(object sender, EventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText($"ListView.Header Button_Clicked.");
		}

		private void Button_Down(object sender, MR.Gestures.DownUpEventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText($"ListView.Header Button_Down.");
		}

		private void Button_LongPressed(object sender, MR.Gestures.LongPressEventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText($"ListView.Header Button_LongPressed.");
		}

		private void Button_Up(object sender, MR.Gestures.DownUpEventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText($"ListView.Header Button_Up.");
		}
	}
}
