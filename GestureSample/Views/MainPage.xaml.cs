...
namespace GestureSample.Views
{
	public partial class MainPage
	{
		private PageConfig[] AllPages = new PageConfig[]
		{
			...
			new PageConfig("Tests", "BindableLayout With Template - No MR.Gestures", () => new BindableLayoutWithTemplateNoMRGestures()),
			new PageConfig("Tests", "ListView.ItemTemplate with MR.Gestures element", () => new ListViewItemTemplatePage { BindingContext = new ViewModels.ListOfStringsViewModel() }),
		...
		private void GCCollect_Clicked(object sender, EventArgs e)
		{
			GC.Collect();
