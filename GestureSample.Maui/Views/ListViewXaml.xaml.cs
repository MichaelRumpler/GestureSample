...
namespace GestureSample.Views
{
	public partial class ListViewXaml
	{
		...
		void Cell_MouseEntered(object sender, MR.Gestures.MouseEventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText("Cell_MouseEntered method called");
		}

		void Cell_MouseMoved(object sender, MR.Gestures.MouseEventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText("Cell_MouseMoved method called");
		}

		void Cell_MouseExited(object sender, MR.Gestures.MouseEventArgs e)
		{
			((TextOnlyViewModel)BindingContext).AddText("Cell_MouseExited method called");
		}

		void Cell_ScrollWheelChanged(object sender, MR.Gestures.ScrollWheelEventArgs e)
		{
